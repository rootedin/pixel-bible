...
(function (PB) {
  PB.addSprites({
    ...
    /* 붉은 줄 — 라합의 창에 맨 줄 (여호수아 2장) */
    cord: { pal: { r: '#c0392b', d: '#8a2418' }, px: ['rd', 'rd', 'dr', 'rd', 'rd', 'dr'] },
    /* 숫양의 뿔 나팔 — 여리고, 기드온 등에서 쓴다 */
    horn: { pal: { b: '#c9a96a', d: '#8a6a3a', l: '#e6cf9a' }, px: ['.....ll', '...bbb.', '..bbd..', '.bd....', 'bb.....'] },
    /* 벽돌 한 장 — 국고 도시 공사 장면용 */
    brick: {
